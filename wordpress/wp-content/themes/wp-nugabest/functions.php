...
function register_html5_menu() {
  register_nav_menus(array(
    ...
    'header-menu-right' => __('Меню в шапке справо', 'wpeasy'),
...
if (function_exists('register_sidebar')) {
  ...
  register_sidebar(array(
    ...
    'id' => 'widgetarea1',
    'before_widget' => '<div id="%1$s" class="widget widget-area %2$s"><div class="widget-wrap">',
  ...
  register_sidebar(array(
    'name' => __('Блок виджетов в футере', 'wpeasy'),
    'description' => __('Description for this widget-area...', 'wpeasy'),
    'id' => 'footer-widgets',
    'before_widget' => '<div id="%1$s" class="footer-widget col-sm-4 %2$s">',
    'after_widget' => '</div>',
    'before_title' => '<h4>',
    'after_title' => '</h4>'
  ));
